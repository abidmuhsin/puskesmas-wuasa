    ...
    <div className='w-full h-screen'>
      ...
      <div className='flex flex-col'>
        ...
        <div className='w-full flex h-[60vh] justify-center items-center gap-20'>
            ...
            <div className='w-[50vh] h-[35vh] flex'>   
              <img src={Poliumum} alt="" className='bg-blue-500 rounded-tl-[15vh] border border-blue-500 border-4 w-[70vh] z-10 absolute right-44 rounded-br-[15vh]'/>
...
//         <div className='relative max-w-full min-h-[75vh] bg-cover bg-center' style={{ backgroundImage: `url(${background})` }}>
//           <div className="absolute inset-0 bg-gradient-to-r from-blue-800 to-cyan-500 opacity-60"></div>
//           <div className='z-10 relative flex flex-col justify-end items-center h-full text-white gap-4 p-4 md:p-8'>
...
//       <div className='max-w-full min-h-auto flex flex-col items-center justify-center px-4 md:px-8'>
//         <h1 className='mt-10 font-bold text-2xl md:text-4xl text-center'>Galeri Layanan Puskesmas Desa Wuasa</h1>
//         <div className='flex flex-col md:flex-row gap-8 justify-center items-center'>
//           <div className='w-full md:w-1/2'>
//             <img src={kpuskesmas} alt="Kepala Puskesmas" className='rounded-3xl w-full' />
//           </div>
//           <div className='flex flex-col md:flex-row gap-5'>
//             <img src={loket} alt="Loket" className='w-full md:w-1/2 rounded-3xl' />
//             <img src={ruanginap} alt="Ruang Inap" className='w-full md:w-1/2 rounded-3xl' />
//             <img src={ruanginap2} alt="Ruang Inap 2" className='w-full md:w-1/2 rounded-3xl' />
//             <img src={ruanginap3} alt="Ruang Inap 3" className='w-full md:w-1/2 rounded-3xl' />
//           </div>
//         </div>
//       </div>
...
//             <img src={Poliumum} alt="Poli Umum" className='bg-blue-500 rounded-tr-[15vh] border border-blue-500 border-4 w-full' />
//             <div className='absolute inset-0 bg-gradient-to-t from-blue-500 to-blue-400 rounded-br-[15vh] z-10'></div>
//           </div>
...
//             <img src={Polianak} alt="Poli Anak" className='bg-blue-500 rounded-tl-[15vh] border border-blue-500 border-4 w-full hidden md:flex' />
//             <div className='absolute inset-0 bg-gradient-to-t from-blue-500 to-blue-400 rounded-br-[15vh] z-10'></div>
//           </div>
//         </div>
//         <div className='flex flex-col md:flex-row items-center justify-between gap-8'>
//           <div className='w-full md:w-1/2 relative'>
//             <img src={Poligigi} alt="Poli Gigi" className='bg-blue-500 rounded-tr-[15vh] border border-blue-500 border-4 w-full hidden md:flex' />
//             <div className='absolute inset-0 bg-gradient-to-t from-blue-500 to-blue-400 rounded-bl-[15vh] z-10'></div>
//           </div>
//           <div className='w-full md:w-1/2 flex flex-col gap-4'>
//             <p className='font-light text-lg'>Poli Gigi</p>
